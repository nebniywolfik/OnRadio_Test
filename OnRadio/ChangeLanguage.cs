...
namespace System.Globalization
{
    class ChangeLanguage
    {
        ...
        {
            Thread.CurrentThread.CurrentUICulture = cultureInfo;// установка новой культыуры для текущего процесса 
            ...
            foreach (string propertyName in properties)
            {
                ...
                foreach (FieldInfo fieldInfo in editFormType.GetFields(BindingFlags.NonPublic | BindingFlags.DeclaredOnly | BindingFlags.Instance))
                {
                    ...
                    if (objProperty == null) continue;//есть ли в ресурсах для данного объекта данное свойство
